use crate::encoders::dotpacking8::sparse_encoder::{DotPackingSparseEncoder, DotPackingSparseQueryEvaluator};
use crate::encoders::dotpacking8::quantizer::ScalarU8Quantizer;
use crate::{Dataset, PlainSparseDataset, SquaredEuclideanDistance};

pub type DotPackingSparseScalarU8Encoder = DotPackingSparseEncoder<ScalarU8Quantizer>;
pub type DotPackingSparseScalarU8QueryEvaluator<'e> = DotPackingSparseQueryEvaluator<'e, ScalarU8Quantizer>;

impl DotPackingSparseEncoder<ScalarU8Quantizer> {
    pub fn new(input_dim: usize) -> Self {
        DotPackingSparseEncoder::new_with_quantizer(
            input_dim,
...
mod tests {
    ...
    fn quantized_values(
        encoder: &DotPackingSparseScalarU8Encoder,
        components: &[u16],
        values: &[f32],
    ) -> Vec<f32> {
        components
    ...
    fn compute_distance_only_bulk() {
        ...
        let mut encoder = DotPackingSparseScalarU8Encoder::new(100);
    ...
    fn verify_gaps(gaps: &[u32]) {
        ...
        let mut encoder = DotPackingSparseScalarU8Encoder::new(u16::MAX as usize + 1);
        encoder.train(&training);
