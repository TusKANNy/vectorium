...
pub type CDotPackingDp8ScalarU8Encoder = CDotPackingDpScalarU8Encoder<8>;
pub type CDotPackingDp16ScalarU8Encoder = CDotPackingDpScalarU8Encoder<16>;

pub type CDotPackingDpScalarU8Encoder<const MAX_LEN: usize> =
    CDotPackingDpEncoder<ScalarU8Quantizer, MAX_LEN>;
pub type CDotPackingDpScalaru8QueryEvaluator<'e, const MAX_LEN: usize> =
    CDotPackingDpQueryEvaluator<'e, ScalarU8Quantizer, MAX_LEN>;

impl<const MAX_LEN: usize> CDotPackingDpScalarU8Encoder<MAX_LEN> {
    pub fn new_with_references(
        input_dim: usize,
        reference_lists: Vec<Vec<u16>>,
        max_ref_size: usize,
    ) -> Self {
        CDotPackingDpEncoder::new(
            input_dim,
...
mod tests {
    ...
    use crate::{
        CDotPackingDp16ScalarU8Encoder, DatasetGrowable,
    ...
    fn quantized_values(
        encoder: &CDotPackingDp16ScalarU8Encoder,
        components: &[u16],
        values: &[f32],
    ) -> Vec<f32> {
        components
    ...
    fn compute_distance_with_only_mapped_bulk() {
        ...
        let mut encoder =
            CDotPackingDp16ScalarU8Encoder::new_with_references(DIM, reference_lists, 128);
