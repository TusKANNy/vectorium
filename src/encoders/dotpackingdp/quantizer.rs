...
use crate::{FixedU8Q, PlainSparseDataset, SpaceUsage, SquaredEuclideanDistance, ValueType};

const FIXED_U8_SCALE: f32 = 1.0 / ((1u32 << FixedU8Q::FRAC_NBITS) as f32);

pub trait DotPackingDpQuantizer: Send + Sync + SpaceUsage {
...
impl DotPackingDpQuantizer for FixedU8Quantizer {
    type InputValue = f32;
...
impl DotPackingDpQuantizer for ScalarU8Quantizer {
    type InputValue = f32;
