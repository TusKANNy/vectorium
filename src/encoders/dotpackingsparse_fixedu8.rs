...
pub type DotPackingSparseFixedU8Encoder = DotPackingSparseEncoder<FixedU8Quantizer>;
pub type DotPackingSparseFixedu8QueryEvaluator<'e> = DotPackingSparseQueryEvaluator<'e, FixedU8Quantizer>;

impl DotPackingSparseEncoder<FixedU8Quantizer> {
    pub fn new(input_dim: usize) -> Self {
        DotPackingSparseEncoder::new_with_quantizer(input_dim, FixedU8Quantizer)
    }
...
mod tests {
    ...
    fn compute_distance_only_bulk() {
        ...
        let encoder = DotPackingSparseEncoder {
            dim: 100,
    ...
    fn block8_decode_roundtrip() {
        let mut encoder = DotPackingSparseEncoder {
            dim: 100,
            quantizer: FixedU8Quantizer,
            component_mapping: None,
            inverse_component_mapping: None,
