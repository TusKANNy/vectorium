...
use crate::encoders::dotpackingdp::quantizer::ScalarU8Quantizer;
use crate::{Dataset, PlainSparseDataset, SquaredEuclideanDistance};

pub type DotPackingDp8ScalarU8Encoder = DotPackingDpScalarU8Encoder<8>;
pub type DotPackingDp16ScalarU8Encoder = DotPackingDpScalarU8Encoder<16>;

pub type DotPackingDpScalarU8Encoder<const MAX_BLOCK_LEN: usize> =
    DotPackingDpEncoder<ScalarU8Quantizer, MAX_BLOCK_LEN>;
pub type DotPackingDpScalaru8QueryEvaluator<'e, const MAX_BLOCK_LEN: usize> =
    DotPackingDpQueryEvaluator<'e, ScalarU8Quantizer, MAX_BLOCK_LEN>;

impl<const MAX_BLOCK_LEN: usize> DotPackingDpScalarU8Encoder<MAX_BLOCK_LEN> {
    pub fn new(input_dim: usize) -> Self {
        DotPackingDpEncoder::new_with_quantizer(
            input_dim,
...
mod tests {
    ...
    use crate::{DatasetGrowable, PlainSparseDatasetGrowable, PlainSparseQuantizer, QueryEvaluator, VectorEncoder};
    ...
    fn quantized_values(
        encoder: &DotPackingDp16ScalarU8Encoder,
        components: &[u16],
        values: &[f32],
    ) -> Vec<f32> {
        components
    ...
    fn compute_distance_only_bulk() {
        ...
        let mut encoder = DotPackingDp16ScalarU8Encoder::new(100);
    ...
    fn verify_gaps(gaps: &[u32]) {
        ...
        let mut encoder = DotPackingDp16ScalarU8Encoder::new(u16::MAX as usize + 1);
        encoder.train(&training);
