...
pub trait DotPacking8Quantizer: Send + Sync + SpaceUsage {
...
impl DotPacking8Quantizer for FixedU8Quantizer {
    type InputValue = f32;
    ...
    fn decode_value(&self, _component: u16, output: u8) -> f32 {
        FixedU8Q::from_bits(output).to_f32().unwrap()
    }
...
impl DotPacking8Quantizer for ScalarU8Quantizer {
    type InputValue = f32;
